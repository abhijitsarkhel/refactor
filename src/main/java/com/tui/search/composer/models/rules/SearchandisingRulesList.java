...
@JsonPropertyOrder({ "name", "Id", "siteID", "user", "publishDate", "action", "TriggerPattern",
...
public class SearchandisingRulesList {
	...
	public SearchandisingRulesList withSearchandisingRulesList(
			List<SearchandisingRulesListNew> searchandisingRulesList) {
		this.searchandisingRulesList = searchandisingRulesList;
		return this;
	}
