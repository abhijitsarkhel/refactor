...
public class ConfigParamsList {
    ...
    public ConfigParamsList withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ConfigParamsList withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ConfigParamsList withPageName(String pageName) {
        this.pageName = pageName;
        return this;
    }
    ...
    public ConfigParamsList withUrl(Object url) {
        this.url = url;
        return this;
    }
    ...
    public ConfigParamsList withAdults(String adults) {
        this.adults = adults;
        return this;
    }
    ...
    public ConfigParamsList withChildAges(String childAges) {
        this.childAges = childAges;
        return this;
    }
    ...
    public ConfigParamsList withDreamLiner(String dreamLiner) {
        this.dreamLiner = dreamLiner;
        return this;
    }
    ...
    public ConfigParamsList withBoardBasis(Object boardBasis) {
        this.boardBasis = boardBasis;
        return this;
    }
    ...
    public ConfigParamsList withPId(String pId) {
        this.pId = pId;
        return this;
    }
    ...
    public ConfigParamsList withMaxPrice(Object maxPrice) {
        this.maxPrice = maxPrice;
        return this;
    }
    ...
    public ConfigParamsList withDiscType(String discType) {
        this.discType = discType;
        return this;
    }
    ...
    public ConfigParamsList withMinDisc(Object minDisc) {
        this.minDisc = minDisc;
        return this;
    }
    ...
    public ConfigParamsList withMaxDisc(Object maxDisc) {
        this.maxDisc = maxDisc;
        return this;
    }
    ...
    public ConfigParamsList withFreeKid(String freeKid) {
        this.freeKid = freeKid;
        return this;
    }
    ...
    public ConfigParamsList withHlo(String hlo) {
        this.hlo = hlo;
        return this;
    }
    ...
    public ConfigParamsList withTpa(String tpa) {
        this.tpa = tpa;
        return this;
    }
    ...
    public ConfigParamsList withTpf(String tpf) {
        this.tpf = tpf;
        return this;
    }
    ...
    public ConfigParamsList withDepartureAirports(String departureAirports) {
        this.departureAirports = departureAirports;
        return this;
    }
    ...
    public ConfigParamsList withStartDate(String startDate) {
        this.startDate = startDate;
        return this;
    }
    ...
    public ConfigParamsList withEndDate(String endDate) {
        this.endDate = endDate;
        return this;
    }
    ...
    public ConfigParamsList withSeasonYear(Object seasonYear) {
        this.seasonYear = seasonYear;
        return this;
    }
    ...
    public ConfigParamsList withDefaultSeasonYear(Object defaultSeasonYear) {
        this.defaultSeasonYear = defaultSeasonYear;
        return this;
    }
    ...
    public ConfigParamsList withDurations(String durations) {
        this.durations = durations;
        return this;
    }
    ...
    public ConfigParamsList withPriceRequired(String priceRequired) {
        this.priceRequired = priceRequired;
        return this;
    }
   ...
   @JsonProperty("spotlights")
    ...
    public ConfigParamsList withSpotlights(List<Spotlight> spotlights) {
        this.spotlights = spotlights;
        return this;
    }
