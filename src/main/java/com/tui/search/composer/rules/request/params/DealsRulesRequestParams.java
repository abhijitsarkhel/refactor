package com.tui.search.composer.rules.request.params;
...
public class DealsRulesRequestParams
{
   ...
   private Integer cruiseOrder;

   private List<ResultsParamsList> resultsParamsList;
   ...
   public Integer getCruiseOrder()
   {
      return cruiseOrder;
   }

   public void setCruiseOrder(Integer cruiseOrder)
   {
